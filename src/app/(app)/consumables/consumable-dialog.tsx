...
import { createConsumable, updateConsumable, type ActionState } from "@/lib/actions/consumables";
...
export function ConsumableDialog({
  ...
  editing?: ConsumableRow;
  trigger?: React.ReactElement;
}) {
  const [open, setOpen] = useState(false);
  const action = editing ? updateConsumable : createConsumable;
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <form action={formAction}>
          <DialogHeader>
            <DialogTitle>{editing ? "Edit Consumable" : "Add Consumable"}</DialogTitle>
            <DialogDescription>e.g. Printer Toner, Cleaning Supplies.</DialogDescription>
          </DialogHeader>
