...
import { createAccessory, updateAccessory, type ActionState } from "@/lib/actions/accessories";
...
export function AccessoryDialog({
  ...
  editing?: AccessoryRow;
  trigger?: React.ReactElement;
}) {
  const [open, setOpen] = useState(false);
  const action = editing ? updateAccessory : createAccessory;
      ...
      <DialogContent>
        <form action={formAction}>
          <DialogHeader>
            ...
            <DialogDescription>e.g. Headset, Keyboard, Docking Station.</DialogDescription>
          </DialogHeader>
